...
var persona1 = new Persona("Juan", "Jimenez Diaz", 45, "13619405S", "10/10", Color.Azul, Sexo.Masculino, new Direccion("Calle Sevilla", "18", "4", "B", "28008", "Madrid", "Madrid"), new Mail(TipoMail.Empresa, "juan.jimenez.diaz@techsolution.es"), new Telefono(TipoTelefono.Empresa, "678923677"), "Informatico residente en Madrid");
var persona2 = new Persona("Lucia", "Arias Lobato", 23, "72135468M", "01/05", Color.Verde, Sexo.Femenino, new Direccion("Calle Santa Lucia", "10", "2", "D", "39006", "Santander", "Cantabria"), new Mail(TipoMail.Personal, "larias_99@gmail.com"), new Telefono(TipoTelefono.Personal, "677899923"), "Estudiante de matematicas en Cantabria");
var persona3 = new Persona("Mario", "Garcia Ruiz", 67, "13151923Z", "13/04", Color.Rojo, Sexo.Masculino, new Direccion("Av. del Cid Campeador", "24", "5", "A", "09005", "Burgos", "Burgos"), new Mail(TipoMail.Personal, "mario_garcia_ruiz@hotmail.com"), new Telefono(TipoTelefono.Personal, "612345678"), "Jubilado residente en Burgos");
